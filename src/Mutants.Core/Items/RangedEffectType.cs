...
/// full ability taxonomy stays in Mutants.Engine.Combat.AbilityEffectType.
/// </summary>
public enum RangedEffectType
{
    ...
    /// (<see cref="Mutants.Core.Monsters.Monster.PendingDefensePenalty"/>),
    /// consumed once by that Mutants.Engine.Combat.CombatSession.
    /// </summary>
    Weaken,
}
