...
public sealed class WorldSimulation
{
    ...
    private ChronTravelers.Core.World.Coordinate _lastPlayerPosition;
    ...
    /// host (ChronTravelers.Game / ChronTravelers.Server): advances Ion drain /
...
public sealed class PlayerTickState
{
    ...
    internal ChronTravelers.Core.World.Coordinate LastPosition { get; set; }
