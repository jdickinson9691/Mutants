...
/// ChronTravelers.Engine.Combat.AbilityEffectType: everything here is
...
/// ChronTravelers.Core (Item's own namespace) rather than alongside abilities in
/// ChronTravelers.Engine, since Core doesn't reference Engine.
/// </summary>
