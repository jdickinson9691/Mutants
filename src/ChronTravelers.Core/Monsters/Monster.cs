...
/// under <c>ChronTravelers.Engine.Npc.MonsterController</c>.
/// </summary>
public sealed class Monster
{
    ...
    /// <summary>A defence penalty applied by a ranged <see cref="Items.RangedEffectType.Weaken"/> shot, consumed once by the next ChronTravelers.Engine.Combat.CombatSession against this monster.</summary>
    ...
    /// ChronTravelers.Engine.Npc.MonsterController; not used while pursuing.
