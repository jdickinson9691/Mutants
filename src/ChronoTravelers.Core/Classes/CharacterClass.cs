...
/// <summary>
/// The five playable/NPC classes — the crew roles of a Chrono project
...
{
    /// <summary>Frontline security — was the Warrior. Strength primary, best HP, cheapest Tachyon drain.</summary>
    Soldier,
