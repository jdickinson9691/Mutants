...
/// adjacent scoping notes in ChronoTravelers.Console); NPCs still contribute to
...
public sealed class CharacterSaveData
{
    ...
    public int CurrentTachyons { get; set; }
    public int MaxTachyons { get; set; }
    public int Credits { get; set; }

    /// <summary>The per-save world seed — fixes the Warden schedule and every year's map/store layout (ChronoTravelers.Core.Time.TimeWorld). 0 on a legacy (schema 1) blob.</summary>
