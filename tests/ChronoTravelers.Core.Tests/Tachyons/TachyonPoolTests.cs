...
public class TachyonPoolTests
{
    [Fact]
    public void NewPool_DefaultsCurrentToMax()
    {
        var pool = new TachyonPool(max: 50);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 15);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 10);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 5);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 20);
        pool.SetMax(10);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 18, uncapped: true);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 19, uncapped: true);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 95, uncapped: true);
    ...
    {
        var pool = new TachyonPool(max: 20, current: 80, uncapped: true);
        pool.SetMax(10);
        Assert.Equal(10, pool.Max);
